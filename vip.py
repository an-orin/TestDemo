...
banner()
key = input("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNhập Key Đã Mua:\033[1;33m ")
check = requests.get(f"https://keyvip24h.dev/api/checkkey.php?key={key}").json()
stt = check["status"]
ten = check["name"]
key_date = check["key_code"]
han_key = check["amount"]
ngay_mua = check["start"]
ngay_het = check["end"]
print(f"\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mTrạng Thái: \033[1;33m{stt}")
sleep(1)
os.system("cls" if os.name == "nt" else "clear")
banner()
...
print("\033[1;37m╚═════════════════════╝")
print(f"\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mTên Người Mua: \033[1;33m{ten}")
print(f"\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mKey Hiện Tại: \033[1;33m{key_date}")
print(f"\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mHạn Key Là: \033[1;33m{han_key}")
print(f"\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNgày Mua: \033[1;33m{ngay_mua}")
print(f"\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNgày Hết Hạn: \033[1;33m{ngay_het}")
bongoc(15)
print("\033[1;37m╔═════════════════════╗")
