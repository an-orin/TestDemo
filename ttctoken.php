...
if ($_SESSION['check'] =='1'){
luachon1:
print $res."🌺".$red."[".$green."✓".$red."]".$green."Bạn Đã Đăng Nhập$cyan Tương Tác Chéo$green Trước Đó. Bấm $yellow Enter $green Để Tiếp Tục, Bấm $red No $green Để Đăng Nhập Tài Khoản Mới : ";
...
print $res."🌺".$red."[".$green."✓".$red."]".$res." =>".$green."Nhập TTC_Access_token ";
...
print $res."🌺".$red."[".$green."✓".$red."]".$res." =>".$green."Xu Hiện Tại: ".$pink.$xuhientai."\n";
...
if ($h == '1'){
for($i = 0; $i < strlen($thanhchay); $i++){print $thanhchay[$i];usleep(1000);}
    echo "\033[1;32m[VMT\033[1;32m]$luc Đang Cấu Hình: ".$yellow.$tenfb." ID: $trang".$idfb."".$res."\n";
    for($i = 0; $i < strlen($thanhchay); $i++){print $thanhchay[$i];usleep(1000);}
} else {
...
function hoanthanh($dem, $type, $id, $xujob, $xu) {
  ...
  $mau = "\e[1;$t"."m";
  $vmt = date('H:i');
echo "\033[1;32m[VMT\033[1;32m]\033[1;31m ❥ \033[1;33m[".$dem."\033[1;33m] \033[1;31m❥ \033[1;36m".date("H:i:s")."\033[1;31m ❥ \033[1;".rand(31,37)."m".$type."\033[1;31m ❥ \033[1;34m ID ĐÃ ẨN \033[1;31m ❥ \033[1;32m$xujob \033[1;31m❥\033[1;93m $xu \n";
	$len = strlen($a);
    for ($x = 0; $x < $len; $x++) {
        print $a[$x];
        usleep(1000);
...
$time = $delay; 
    for ( $x = $time; $x--; $x ) {
    echo "                                                      \r";
       echo "\033[1;32m❥ Vũ Mạnh Tuấn <~> Chờ\033[1;93m $x\033[1;91m | ";
usleep(133333);
echo "\033[1;31m -  ";
usleep(133333);
echo "\033[1;32m -  ";
...
$thanhchay = "\33[1;97m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n";
$vmt="\33[1;97m        
             TOOL PHÍ VÀ CỰC CHẤT LƯỢNG
\033[1;31m               ___   _  __  ____  ___  _____  __
\033[1;32m              / _ | / |/ / / __ \/ _ \/  _/ |/ /
\033[1;33m             / __ |/    / / /_/ / , _// //    / 
\033[1;34m            /_/ |_/_/|_/  \____/_/|_/___/_/|_/  
\033[1;36m            Group FB: \033[1;33mhttps://fb.com/498562511843475
\033[1;32m            Group Zalo: \033[1;37mhttps://zalo.me/g/goxsks440
\033[1;33m            Youtube: An Orin
\033[1;37m            Mua key Và Tải Tool
\033[1;33m            ✅Tại đây: \033[1;36mhttps://keytoolsstool.tk/
\033[1;32m ══════════════════════════════════════════════════════════════
\033[1;36m                               TOOL FREE
\033[1;32m ══════════════════════════════════════════════════════════════\n";
